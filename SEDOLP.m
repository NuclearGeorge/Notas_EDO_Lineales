...
ST[ti_,tf_]:=Show[Plot[SOLCIX[t][[1]],{t,ti,tf},PlotStyle->{Blue,Thick},ImageSize->700,AxesLabel->{t," "},LabelStyle->Directive[Black,Bold ,50,FontFamily->"Courier New"],PlotRange-> All,Prolog-> {White,Rectangle[Scaled[{-2,-2}],Scaled[{2,2}]]},RotateLabel->False,FrameTicks->{True,True},Frame-> True,PlotLegends->{"\!\(\*SubscriptBox[\(x\), \(1\)]\)"}],Plot[SOLCIX[t][[2]],{t,ti,tf},PlotStyle->{Green,Thick},ImageSize->700,AxesLabel->{t," "},LabelStyle->Directive[Black,Bold ,50,FontFamily->"Courier New"],PlotRange-> All,Prolog-> {White,Rectangle[Scaled[{-2,-2}],Scaled[{2,2}]]},RotateLabel->False,FrameTicks->{True,True},Frame-> True,PlotLegends->{"\!\(\*SubscriptBox[\(x\), \(2\)]\)"}]];
